package com.xfj.spider.generate;
...
public class MpGenerator {
     ...
     * 作者
     */
    private static String authorName="xnc";
    /**
     * table名字
     */
    private static String[] table = new String[]{"esf_tools_spider_proxy_ip"};
    /**
     * table前缀
     */
     ...
     * 数据库信息
     */
    private static String dataSourceUrl = "jdbc:mysql://192.168.10.17:3306/xfjtest?useUnicode=true&characterEncoding=utf8";
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new StrategyConfig()
                        ...
                        // 自定义 mapper 父类
                        //.setSuperMapperClass("com.xfj.spider.mapper")
                        // 自定义 service 父类
                        //.setSuperServiceClass("com.xfj.spider.service")
                        // 自定义 service 实现类父类
                        //.setSuperServiceImplClass("com.xfj.spider.serviceImpl")
                        // 自定义 controller 父类
                        //.setSuperControllerClass("com.xfj.spider.controller")
                ...
                new PackageConfig()
                        //.setModuleName("model")
                        .setParent("com.xfj.spider")// 自定义包路径
